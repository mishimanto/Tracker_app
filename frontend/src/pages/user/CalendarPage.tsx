          ...
          <div className="border-b border-slate-200 bg-linear-to-r from-slate-950 via-slate-900 to-sky-900 px-5 py-6 text-white sm:px-6">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                {/* <h1 className="mt-4 text-3xl font-semibold">{monthLabel}</h1>
                <p className="mt-2 text-sm text-slate-300">
                  Review monthly activity at a glance and open any day for full details.
                </p> */}
              </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {hasActivity && (
                      <span className="bg-red-100 px-2 py-0.5 rounded-sm text-red-500 text-[13px] font-bold tracking-[0.12em]">
